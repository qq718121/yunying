  ...
  <div>
    ...
    <div style="padding:20px" class="dia_wap_in">
      <el-row style="border:1px solid #ccc;padding:20px 10px 0px">
        ...
        <el-col :span="4">
          <el-button type="primary" style="float: right;margin-left: 10px" v-if="$route.query.type=='edit'"
                     @click="addNew">添加报告
          </el-button>
      ...
      <BigDialog dialogTitle="添加报告" :dialogFormVisible="dialogFormVisible" @dialogCancel="dialogCancel"
      ...
      <BigDialog dialogTitle="添加报告" :isShowCancel="false" :dialogFormVisible="dialogFormVisible2"
                 @dialogConfirm="dialogConfirm(2)">
        <div slot="dia_body">
          <el-form style="" :model="paParkDetail" class="demo-form-inline" label-width="150px">
