  ...
  <div class="managers">
    ...
    <div style="padding:20px">
        ...
        <el-col :span="22">
          <el-form :inline="true" :model="filterForm" class="demo-form-inline">
            ...
            <el-form-item label="区域">
              <MjbArea :isShowArea="true" :_province.sync="filterForm.province" :_city.sync="filterForm.city" :_area.sync="filterForm.area" />
            </el-form-item>
            ...
            <el-form-item label="分配时间">
              <el-date-picker size="small" style="width:300px" @change="pickerChange" v-model="editTime" type="datetimerange" align="right" placeholder="选择日期范围">
              </el-date-picker>
            </el-form-item>
      ...
      <div class="tabletopbar">
        ...
        <span style="color:#111">{{tableData.bCount}}</span>
        <span>条</span>
      ...
      <el-table v-loading="tabLoading" 
        ...
        <el-table-column prop="buildingId" label="ID" width="100">
        </el-table-column>
        <el-table-column prop="buildingName" label="楼盘名" min-width="60">
        </el-table-column>
        <el-table-column prop="locatArea" label="所在地区" min-width="60">
        </el-table-column>
        <el-table-column prop="isAllocate" label="是否分配" min-width="80">
          <template scope="scope">
            <span v-if="scope.row.isAllocate===1">是</span>
            <span v-else>否</span>
          </template>
        </el-table-column>
        <el-table-column prop="collector" label="采集人" min-width="60">
        </el-table-column>
        <el-table-column prop="assignor" label="分配人" min-width="60">
        </el-table-column>
        <el-table-column prop="distributeTime" min-width="80" label="分配时间">
        </el-table-column>
      ...
      <el-pagination v-show="tableData.bCount>0" style="margin: 0 auto;text-align:center;margin-top:20px" layout="prev, pager, next,jumper" :page-size=10 :currentPage="currentPage" @current-change="currentChange" :total="tableData.bCount">
      </el-pagination>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      navList: [
        ...
        { path: this.$route.fullPath, name: "监控楼盘采集" },
  ...
  methods: {
    ...
    getData() {
      ...
      this.$http(
        "/taskManage/getCollectionList",
        { body: _this.filterForm },
        {},
        {},
        "post"
      )
