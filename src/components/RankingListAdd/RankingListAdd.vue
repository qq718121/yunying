...
export default {
    ...
    methods: {
      ...
      editRankBuild(row){
        ...
        console.log(this.addAllData.buildForm)
      },
      refresh(){
...
<style scoped>
  ...
  .RankingListAdd .itemB .formList{width:80%;}
