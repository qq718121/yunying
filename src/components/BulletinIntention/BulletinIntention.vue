    ...
    data() {
      return {
        navList: [
          ...
          {path: this.$route.fullPath, name: '意向订阅'},
        ],
        currentPage: 1,
        buidingList: [],
...
//          buildStatus: ''
    ...
    methods: {
      ...
      getData(){
        ...
        this.$http('/backstageUser/getIntentionSubscripList', {body: _this.filterForm}, {}, {}, 'post').then(function (res) {
      ...
      handleEdit(index, row, type) {
        if (type == 1) {
          this.$router.push({
            path: '/subscribe/bulletinIntentionDetails',
