<template>
  <div>
       <el-form-item label="位置信息：" v-show="status!='edit'"
                  >
   ...
   <el-form-item  label="功能分区：" v-show="status!='edit'" v-if="filterForm2.menuChildId0 === 134 || filterForm2.menuChildId0===4057">
    ...
    <el-form-item label="功能分区：" v-show="status!='edit'"
