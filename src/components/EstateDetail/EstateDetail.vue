      ...
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="楼盘基本信息" name="first">
          ...
          <div class="first_item_3">
            ...
            <el-form label-width="150px" class="demo-dynamic" style="width:60%;margin-left:15%;margin-top:40px">
              ...
              <div  style="width:1000px;border-top:1px solid #c7d2de;margin:10px 0;height:0px;"></div>
                <el-form-item  label="楼盘亮点" style="width:600px;;padding:10px 0;" prop="brightList2">
                        <span style="margin-left:20px;" :label="item.id"
                                                v-if="item.brightStatus == 1" 
                                                v-for="(item,index) in houseBasicData.brightList" 
                                                :key="index">{{item.brightName}}</span>
                </el-form-item>
            </el-form>
          </div>
        </el-tab-pane>
          ...
          <el-tabs v-model="activeName2" @tab-click="imgTabClick">
            <el-tab-pane label="户型图" name="first" style="padding:0px 20px">
              <div v-show="hxAllData.is_show_hx_main">
                <el-table v-loading="hxAllData.is_loading_tab" :data="hxAllData.hxTableData.houseList" border tooltip-effect="dark" style="width: 100%;font-size:12px!important;">
                  ...
                  <el-table-column min-width="200" label="操作">
                    <template scope="scope">
                      <el-button size="small" @click="hxDetailView(scope.row)">查看</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              ...
              <div v-show="!hxAllData.is_show_hx_main">
                ...
                <el-form :model="hxAllData.addNewHouseType" ref="addNewHouseTypeRef" label-width="100px" class="demo-dynamic" style="width:55%;margin:0 auto;margin-top:40px">
                  ...
                  <el-form-item label="标签：">
                    <el-tag style="margin-right: 20px;" type="danger" :key="index" v-for="(item,index) in hxAllData.addNewHouseType.houseLable">
                      {{item}}
                    </el-tag>
                ...
                <el-form-item label="物业类型" prop="propertyType">
                    <span>{{hxAllData.addNewHouseType.propertyType}}</span>
                  </el-form-item>

                   <el-form-item label="物业类型" prop="familyStructure">
                    <span>{{hxAllData.addNewHouseType.familyStructure}}</span>
                  </el-form-item>

                  <el-form-item label="户型分布" prop="typeDistribution">
                   <span>{{hxAllData.addNewHouseType.typeDistribution}}</span>
                  </el-form-item>

                  <el-form-item label="预览" class="previewFormItem">
                    <ImgPreview v-show="hxAllData.addNewHouseType.houseImgUrl" :isShowDelete="isShowDelete" :backgroundPicUrl="hxAllData.addNewHouseType.houseImgUrl" @previewImg="previewImgHx(hxAllData.addNewHouseType.houseImgUrl)" />
            ...
            <el-tab-pane label="实景图" name="second" style="padding:0px 20px">
              <div v-show="sjAllData.is_show_sj_main">
                <el-table :data="sjAllData.sjTableData.sceneList" border tooltip-effect="dark" style="width: 100%;font-size:12px!important;">
                  <el-table-column label="图片" min-width="100">
                    <template scope="scope">
                  ...
                  <el-table-column min-width="100" label="操作">
                    <template scope="scope">
                      <el-button size="small" @click="sjDetailView(scope.row)">查看</el-button>
                    </template>
                  </el-table-column>
                </el-table>
              ...
              <div v-show="!sjAllData.is_show_sj_main">
                ...
                <el-form :model="sjAllData.addNewSj" label-width="100px" class="demo-dynamic" style="width:55%;margin:0 auto;margin-top:40px">
                  ...
                  <el-form-item label="预览" class="previewFormItem">
                    <ImgPreview v-show="sjAllData.addNewSj.imgUrl" :isShowDelete="isShowDelete" :backgroundPicUrl="sjAllData.addNewSj.imgUrl" @previewImg="previewImgSj(sjAllData.addNewSj.imgUrl)" />
            ...
            <el-tab-pane label="效果图" name="third" style="padding:0px 20px">
              ...
              <el-form :model="xgAllData" label-width="100px" class="demo-dynamic">
                <el-form-item label="" class="previewFormItem">
                  <ImgPreview :isShowDelete="isShowDelete" v-for="(item,index) in xgAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgXg(index)" />
            ...
            <el-tab-pane label="样板间" name="fourth" style="padding:0px 20px">
              ...
              <el-form :model="ybjAllData" label-width="100px" class="demo-dynamic">
                <el-form-item label="" class="previewFormItem">
                  <ImgPreview :isShowDelete="isShowDelete" v-for="(item,index) in ybjAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgYbj(index)" />
            ...
            <el-tab-pane label="规划图" name="five" style="padding:0px 20px">
              ...
              <el-form :model="ghAllData" label-width="100px" class="demo-dynamic">
                <el-form-item label="" class="previewFormItem">
                  <ImgPreview :isShowDelete="isShowDelete" v-for="(item,index) in ghAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgGh(index)" />
            ...
            <el-tab-pane label="交通图" name="six" style="padding:0px 20px">
              ...
              <el-form :model="jtAllData" label-width="100px" class="demo-dynamic">
                <el-form-item label="" class="previewFormItem">
                  <ImgPreview :isShowDelete="isShowDelete" v-for="(item,index) in jtAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgJt(index)" />
            ...
            <el-tab-pane label="缩略图" name="seven" style="padding:0px 20px">
              ...
              <el-form :model="slAllData" label-width="100px" class="demo-dynamic">
                <el-form-item label="" class="previewFormItem">
                  <ImgPreview :isShowDelete="isShowDelete" v-for="(item,index) in slAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgSl(index)" />
        ...
        <el-tab-pane label="楼盘全景" name="fourth">
          <div>
            <div v-show="showType == 1">
              <el-table v-loading="tabLoading" :data="paData.buidingVRList" border tooltip-effect="dark" style="font-size:12px!important;text-align:center;margin-top:20px">
                <el-table-column prop="id" label="ID" min-width="100">
                </el-table-column>
                <el-table-column prop="airscapeUrl" label="鸟瞰图" min-width="80">
                </el-table-column>
                <el-table-column prop="sceneUrl" label="楼盘实景" min-width="100">
                </el-table-column>
                <el-table-column prop="sampleUrl" label="样板间" min-width="100">
                </el-table-column>
                <el-table-column prop="sandTableUrl" label="楼盘沙盘" min-width="100">
                </el-table-column>
                <el-table-column prop="perimetUrl" label="周边配套" min-width="100">
                </el-table-column>
                <el-table-column prop="createDate" label="创建时间" min-width="100">
                </el-table-column>
                <el-table-column prop="editTime" label="最近更新时间" min-width="100">
                </el-table-column>
                <el-table-column width="300" label="操作">
                  <template scope="scope">
                    <el-button size="small" @click="handle(scope.row,1)">
                      查看
                    </el-button>
                  </template>
                </el-table-column>
              </el-table>
              <el-pagination v-show="paData.rowCount>0" style="margin: 0 auto;text-align:center;margin-top:20px" layout="prev, pager, next" :page-size=10 :currentPage="currentPage" @current-change="currentChange" :total="paData.rowCount">
              </el-pagination>
            </div>
            <div v-show="showType == 2">
              <el-button type="text" @click="back">返回列表</el-button>
              <el-form :model="handleForm" label-width="100px" class="demo-dynamic" style="width:70%;margin:0 auto;margin-top:40px">

                <el-form-item label="全景缩略图" style="width:800px" required>

                  <ImgPreview :backgroundPicUrl="preImgSrcList[0].preImgSrc" :isShowDelete="handleType != 'view'" @previewImg="previewImgPa(0)" @deleteImg="deleteImgPa(0)" />
                </el-form-item>
        ...
        <el-tab-pane label="楼盘报告" name="five" style="padding:20px">
          <div>
            ...
            <el-table v-loading="is_loading_report_table" :data="report_data.reportList" border tooltip-effect="dark" style="width: 100%;font-size:12px!important;text-align:center;margin-top:20px">
              <el-table-column prop="reportName" label="报告名" min-width="100">
              </el-table-column>
              <el-table-column prop="reportType" label="报告类型" min-width="80">
                <template scope="scope">
              ...
              <el-table-column prop="onlineTime" label="发布时间" width="200">
              </el-table-column>
              ...
              <el-table-column prop="operateMan" label="发布人" min-width="60">
              </el-table-column>
              <el-table-column min-width="100" label="操作">
                <template scope="scope">
                  <el-button size="small" @click="handleRepeat(scope.row,1)">
                    查看
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination v-show="report_data.rowCount>0" style="margin: 0 auto;text-align:center;margin-top:20px" layout="prev, pager, next,jumper" :page-size=10 :currentPage="report_data.currentPage" @current-change="reportCurrentChange" :total="report_data.rowCount">
            </el-pagination>
          </div>
        </el-tab-pane>
        <el-tab-pane label="楼盘设置" name="six">
          <el-form label-width="150px" class="demo-dynamic" style="width:60%;margin-left:15%;margin-top:20px">
            ...
            <el-form-item label="楼盘群聊：">
              <span v-if="form.configList[5].configValue==='' || form.configList[5].configValue===null">--</span>
              <span v-if="form.configList[5].configValue===1">启动</span>
              <span v-if="form.configList[5].configValue===0">停止</span>
            </el-form-item>
            <el-form-item label="开盘变价订阅通知：">
              <span v-if="form.configList[6].configValue==='' || form.configList[6].configValue===null">--</span>
              <span v-if="form.configList[6].configValue===1">启动</span>
              <span v-if="form.configList[6].configValue===0">停止</span>
            </el-form-item>
            <el-form-item label="户型介绍：">
              <span v-if="form.configList[7].configValue==='' || form.configList[7].configValue===null">--</span>
              <span v-if="form.configList[7].configValue===1">启动</span>
              <span v-if="form.configList[7].configValue===0">停止</span>
            </el-form-item>
          </el-form>
        </el-tab-pane>
...
import EstatedirOpenP from "../EstateEdit/EstateditOpenP.vue"
export default {
    ...
    return {
      ...
      form: {
        configList: [
          ...
          { configType: 5, configValue: "" },
          { configType: 6, configValue: "" },
          { configType: 7, configValue: "" }
        ]
      },
  ...
  methods: {
      ...
      this.$http("/backstageBuilding/getBuildingInfo", {}, { body }, {}).then(
        function(res) {
          if (res.data.code == 0) {
            ...
            //标注
            _this.center = [
              _this.houseBasicData.mapLon,
              _this.houseBasicData.mapLat
            ];
            let content =
              "<div classname='buildingAdd' style='background:rgba(0,0,0,.7);width: 60px;height: 20px;line-height: 20px;text-align: center;font-size: 12px;color: white;'>楼盘位置</div>";
    ...
    getInfoData() {
      ...
      this.$http(
        "/backstageBuilding/getBuildingAttachInfo",
        {},
        { body },
        {},
        "get"
    ...
    getProData() {
      let _this = this,
        body = { cityType: 1 };
      _this
        .$http("/citis/cityLists", { body }, {}, {}, "post")
        .then(function(res) {
          if (res.data.code == 0) {
            ...
            _this.hxAllData.houseLableList.forEach(item => {
              _houseLable.forEach(item2 => {
                if (item2 == item.lableId) {
                  _this.hxAllData.addNewHouseType.houseLable.push(
                    item.lableName
                  );
                }
              });
    ...
    getImgData(type) {
      ...
      this.$http("/backstageBuilding/getBuildingAlbumList", {}, { body }, {})
        .then(res => {
          if (res.data.code == 0) {
            if (type == 1) {
    ...
    getPaData() {
      ...
      this.$http(
        "/backstageBuilding/getBuildVRList",
        { body },
        {},
        {},
        "post"
    ...
    getReportData(reportType = "") {
      ...
      this.$http(
        "/backstageBuilding/getBuildingReportList",
        {},
        { body },
        {}
      ).then(res => {
    ...
    handleCheckAllChange(val) {
      this.report_data.form.reportType = this.checkAll
        ? ["0", "1", "2", "3", "4", "5"]
        : [];
    ...
    handleRepeat(scope, type) {
      ...
      if (type == 1) {
        ...
        this.$http("/backstageBuilding/getReportInfo", {}, { body }, {})
          .then(res => {
            if (res.data.code == 0) {
    ...
    getSettingdata() {
      let _this = this,
        body = { buildingId: this.$route.query.buildingId };
      this.$http("/backstageBuilding/getBuildingConfig", {}, { body }, {}).then(
        function(res) {
          if (res.data.code == 0) {
            ...
            _form.forEach((item, index) => {
              if (item.configType == 0) {
                ...
                _this.form.configList[5].configValue = item.configValue;
              }else if (item.configType == 6) {
                _this.form.configList[6].configValue = item.configValue;
              } else if (item.configType == 7) {
                _this.form.configList[7].configValue = item.configValue;
              }
            });
          }
        }
...
.estateadd .el-upload--picture-card {
  display: none;
}
