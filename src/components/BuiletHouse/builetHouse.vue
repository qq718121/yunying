  ...
  export default {
    ...
    data() {
      return {
        navList: [
          ...
          {path: this.$route.fullPath, name: '楼盘订阅'}
        ],
        currentPage: 1,
    ...
    methods: {
      ...
      getData(){
        ...
        this.$http('/backstageSub/getSubBuildList', {body: this.filterForm}, {}, {}, 'post').then(res => {
    ...
    mounted(){
      ...
      this.$store.dispatch('defaultIndexAction', '/subscribe/builetHouse');
    }
  }
</script>
