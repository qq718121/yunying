<template>
  <div>
    <el-row style="border:1px solid #ccc;padding:20px 10px 0px">
        ...
        <el-form :inline="true" :model="filterForm" class="demo-form-inline">
          <el-form-item label="楼栋号：">
            <el-select size="small" placeholder="不限" v-model="filterForm.fkId" clearable style="width:150px;">
              <el-option v-for="(item,index) in buildingNumArray" :key="index" :label="item.id"
      ...
      <el-col :span="4">
        <el-button style="float:right;margin-left:5px;" type="primary" @click="addNew" v-if="type==='edit'">添加楼栋全景
    ...
    <BigDialog dialogTitle="添加楼栋全景" :dialogFormVisible="dialogFormVisible" @dialogCancel="dialogCancel(1)"
    ...
    <BigDialog dialogTitle="楼栋全景详情" :isShowCancel="false" :dialogFormVisible="viewDialogFormVisible"
      ...
      <div slot="dia_body">
        <el-form style="" class="demo-form-inline" label-width="150px">
          ...
          <el-form-item label="上传时间：">
            <p>{{editAndCreatePaParkDetail.submitTime}}</p>
          </el-form-item>
...
<script>
  ...
  export default{
    ...
    mounted(){
      ...
      console.log(window.localStorage.buildingNumArray);
    },
    methods: {
      //获取标签内容
      getLabelData(){
