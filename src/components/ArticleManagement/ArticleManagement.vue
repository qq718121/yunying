                ...
                <div>
                    <el-form :inline="true" :model="filterForm" class="demo-form-inline">
                        ...
                        <el-form-item label="发布人">
                            <el-select size="small" v-model="filterForm.backstageUserId" :clearable="true" placeholder="发布人"  style="width:120px;">
                                <el-option
                        ...
                        <el-form-item label="楼盘名称" v-if="filterForm.newsTypeId == 5">
            ...
            <el-table
                ...
                show-overflow-tooltip>
                    <template scope="scope">
                        ...
                        <span v-if="scope.row.newsTypeId=='5'">楼盘评测</span>
                ...
                <el-table-column width="400px" label="操作">
                    <template scope="scope" >
                        ...
                        size="small"
                        type="button"
                        v-clipboard:copy="scope.row.newsPath"
    ...
    export default {
        ...
        methods: {
            getdata(){
                ...
                if(body.newsTypeId != 5){
                    body.buildingName = "";
                }
                _this.is_loading_tab=true;
                this.$http('/news/newsInfoList',{body},{},{},'post').then(function(res){
            ...
            //         body.id = row.id;
            //         body.cids = row.cids;
            //      this.$http('/news/copyNewsPath',{body},{},{},'post').then(function(res){
            //         console.log(res)
            //         if(res.data.code== 0 ){
            //             console.log(res.data);
            //             _this.copyMessage = res.data.response.newsPath
            //         }
            //     }).catch(function(err){
            //         console.log(err)
            //     })
