    ...
    <div style="padding:20px">
      ...
      <el-table
        ...
        <el-table-column
          ...
          min-width="60">
          <template scope="scope">
            <span v-if="scope.row.buildingStatus === 1">已上线</span>
            <span v-if="scope.row.buildingStatus === 0">已下线</span>
          </template>
        </el-table-column>
        <el-table-column
          prop="developNumber"
  ...
  export default {
    ...
    created(){
        if(this.$route.query.data){
            this.filterForm = this.$route.query.data;
        }
      this.getData();
    },
    methods: {
