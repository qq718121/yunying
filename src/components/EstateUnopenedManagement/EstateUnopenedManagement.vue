  ...
  <div class="managers">
    ...
    <div style="padding:20px">
      ...
      <div class="tabletopbar">
        ...
        <span style="color:#111">{{tableData.nCount}}</span> <span>条</span>
     ...
     <el-dialog
      ...
      <el-pagination
        v-show="tableData.nCount>0"
        style="margin: 0 auto;text-align:center;margin-top:20px"
        layout="prev, pager, next,jumper"
        :page-size=10
        :currentPage="currentPage"
        @current-change="currentChange"
        :total="tableData.nCount">
      </el-pagination>
    </div>
...
export default {
    ...
    data() {
      return {
        ...
        navList:[
          ...
          {path:this.$route.fullPath,name:'质量寻光楼盘审核'},
    ...
    methods: {
      ...
      getData(){
        ...
        this.$http('/taskManage/getNoOpenAuditList',{body:_this.filterForm},{},{},'post').then(function(res){
      ...
      handleEdit(index, row ,type) {
        ...
        if(type == 1){
          this.$router.push({
            path:'/task/estateunopeneddetail',
            query:{
              type:'view',
    ...
    getPerData(rId){
      let _this = this;
     let body = {roleId:rId};
      this.$http('/taskManage/getNoOpenUserList',{body},{},{},'post').then(function(res){
        if(res.data.code == 0){
