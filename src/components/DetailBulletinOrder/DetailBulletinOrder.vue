...
<script>
  ...
  export default {
    ...
    data() {
      return {
        navList: [
          {path: '/subscribe/builetSeeklint', name: '首页'},
          {path: '/subscribe/builetSeeklint', name: '质量监控预约'},
          {path: this.$route.fullPath, name: '预约用户详情'}
        ],
        currentPage: 1,
        filterForm: {
          pageNum: 0,
...
//          userStatus: '',
    ...
    methods: {
      ...
      getdata(){
        ...
        this.$http('/backstageSub/getBesBuildInfoList', {body: _this.filterForm}, {}, {}, 'post').then(function (res) {
