  ...
  <div class="login" @keyup.enter="submitForm('ruleForm2')">
    ...
    <div class="loginBox">
      <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm"
               style="margin-top:90px;margin-right:170px;margin-left:70px">
            ...
            this.$http('/backstageUser/login', {body}, {}, {}, 'post').then(res => {
              if (res.data.code == 0) {
                ...
                this.getData(id);
                  ...
                  message(this, res.data.message, 'warning')
...
<style scoped>
  .login {
    height: 100%;
    background: #3283AC url('../../assets/login/admin-login-bg.jpg') no-repeat center;
    min-height: 500px;
    min-width: 600px;
    position: absolute;
    left: 0;
  ...
  .loginBox {
    ...
    margin-left: -309px;
    margin-top: -184px;
    background: url('../../assets/login/admin-loginform-bg.png') no-repeat
  }
  ...
  .code {
    ...
    float: right;
    background: url('../../assets/login/admin-login-bg.jpg');
    text-align: center;
    line-height: 36px;
    color: #313131;
    font-weight: bold;
