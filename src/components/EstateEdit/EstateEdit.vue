  ...
  <div class="estateadd">
    ...
    <div style="padding:20px">
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        ...
        <el-tab-pane label="最新开盘" name="addEight">
            <EstatedirOpenP />
        </el-tab-pane>
          ...
          <el-tabs v-model="activeName2" @tab-click="imgTabClick">
            <el-tab-pane label="户型图" name="first">
              <div v-show="hxAllData.is_show_hx_main">
                ...
                <el-table v-loading="hxAllData.is_loading_hx_tab" :data="hxAllData.hxtableData.houseList" border tooltip-effect="dark" style="width: 100%;font-size:12px!important;">
                  <el-table-column prop="houseId" label="ID" min-width="80">
                  </el-table-column>
                  ...
                  <el-table-column prop="house" label="户型" min-width="80">
                  </el-table-column>
                  <el-table-column prop="describe" label="描述" min-width="100">
                  </el-table-column>
                  <el-table-column prop="saleStatus" label="销售状态" min-width="60">
                  </el-table-column>
                  <el-table-column prop="createTime" min-width="80" label="发布时间">
                  </el-table-column>
                  <el-table-column min-width="80" label="上下线">
                     <template scope="scope">
                  ...
                  <el-table-column min-width="140" label="操作">
                    <template scope="scope">
                      <el-button size="small" @click="handleHx(scope.$index, scope.row,1)">修改</el-button>
                      <el-button size="small" @click="handleHx(scope.$index, scope.row,3)">{{scope.row.onlineStatus=='1'?"下线":"上线"}}</el-button>
                      <el-button size="small" @click="handleHx(scope.$index, scope.row,2)">删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
                <el-pagination v-show="hxAllData.hxtableData.rowCount>0" style="margin: 0 auto;text-align:center;margin-top:20px" layout="prev, pager, next,jumper" :page-size=10 :currentPage="hxAllData.currentPage" @current-change="hxListCurrentChange" :total="hxAllData.hxtableData.rowCount">
                </el-pagination>
              </div>
              <div v-show="!hxAllData.is_show_hx_main">
                <el-button type="text" @click="show_add_hx_form(true)">返回列表</el-button>
                <el-form :model="hxAllData.addNewHouseType" :rules="hxAllData.addNewHouseTypeRule" ref="addNewHouseTypeRef" label-width="100px" class="demo-dynamic" style="width:70%;margin:0 auto;margin-top:40px">
                  ...
                  <el-form-item label="户型" style="width:800px" :required="true" prop="room">
                    <el-select :clearable="true" style="width:150px" v-model="hxAllData.addNewHouseType.room" placeholder="室">
                      ...
                      <el-option label="九室" :value="9"></el-option>
                      <el-option label="十室" :value="10"></el-option>
                    </el-select>
                    <el-select :clearable="true" style="width:150px" v-model="hxAllData.addNewHouseType.hall" placeholder="厅">
                      ...
                      <el-option label="六厅" :value="6"></el-option>
                      <el-option label="七厅" :value="7"></el-option>
                      <el-option label="八厅" :value="8"></el-option>
                      <el-option label="九厅" :value="9"></el-option>
                      <el-option label="十厅" :value="10"></el-option>
                    </el-select>
                    <el-select :clearable="true" style="width:150px" v-model="hxAllData.addNewHouseType.kitchen" placeholder="厨">
                      ...
                      <el-option label="三厨" :value="3"></el-option>
                      <el-option label="四厨" :value="4"></el-option>
                      <el-option label="五厨" :value="5"></el-option>
                      <el-option label="六厨" :value="6"></el-option>
                      <el-option label="七厨" :value="7"></el-option>
                      <el-option label="八厨" :value="8"></el-option>
                      <el-option label="九厨" :value="9"></el-option>
                      <el-option label="十厨" :value="10"></el-option>
                    </el-select>
                    <el-select :clearable="true" style="width:150px" v-model="hxAllData.addNewHouseType.bathRoom" placeholder="卫">
                      ...
                      <el-option label="六卫" :value="6"></el-option>
                      <el-option label="七卫" :value="7"></el-option>
                      <el-option label="八卫" :value="8"></el-option>
                      <el-option label="九卫" :value="9"></el-option>
                      <el-option label="十卫" :value="10"></el-option>
                    </el-select>
                  </el-form-item>
                  ...
                  <el-form-item label="朝向" :required="true" prop="roomLocation">
                    <el-select :clearable="true" v-model="hxAllData.addNewHouseType.roomLocation" placeholder="朝向">
                      <el-option v-for="(item,index) in roomLocationList" :key="index" :label="item.value" :value="item.key"></el-option>
                    </el-select>
                  </el-form-item>
                  ...
                  <el-form-item label="标签">
                    <el-checkbox-group v-model="hxAllData.addNewHouseType.houseLable">
                      <el-checkbox v-for="(item,index) in hxAllData.houseLableList" :key="index" :label="item.lableId">
                        {{item.lableName}}
                      </el-checkbox>
                    </el-checkbox-group>
                  </el-form-item>
                ...
                <el-form-item label="物业类型" prop="propertyType">
                    <el-radio-group v-model="hxAllData.addNewHouseType.propertyType">
                      <el-radio label="普通住宅">普通住宅</el-radio>
                      <el-radio label="公寓">公寓</el-radio>
                      <el-radio label="商住">商住</el-radio>
                      <el-radio label="别墅">别墅</el-radio>
                      <el-radio label="0">其他</el-radio>
                    </el-radio-group>
                    <el-input size="small" :maxlength="5" style="width:200px" v-model="hxAllData.addNewHouseType.propertyType2" placeholder="请输入其他项"></el-input>
                  </el-form-item>

                   <el-form-item label="户型结构" prop="familyStructure">
                    <el-radio-group v-model="hxAllData.addNewHouseType.familyStructure">
                      <el-radio label="平层">平层</el-radio>
                      <el-radio label="跃层">跃层</el-radio>
                      <el-radio label="复式">复式</el-radio>
                    </el-radio-group>
                  </el-form-item>

                  <el-form-item label="户型分布" prop="typeDistribution">
                    <el-input size="small" :maxlength="200" style="width:300px" v-model="hxAllData.addNewHouseType.typeDistribution" placeholder="请输入户型所在期数地块及楼栋"></el-input>
                    <span style="margin-left:20px;">如一期A地块2号楼，分布多个楼栋可用逗号分割</span>
                  </el-form-item>

                  <el-form-item label="上传" required>
                    <ImgUploader2 :btnId="hxAllData.btnList[0]" @imgUploader="imgUploaderHx(0)" />
                  </el-form-item>
                  <el-form-item label="预览" class="previewFormItem">
                    <ImgPreview v-for="(item,index) in hxAllData.preImgSrcList" 
                    :key="index" 
                    :backgroundPicUrl="item.preImgSrc"
                    @previewImg="previewImgHx(index)" 
                    @deleteImg="deleteImgHx(index)" />
                    <p v-if="hxAllData.addNewHouseType.houseImgUrlList.length<1" class="no-img">
                      暂无预览图
                    </p>
                  </el-form-item>
                  <el-form-item label="">
            ...
            <el-tab-pane label="实景图" name="second">
              <div v-show="sjAllData.is_show_sj">
                ...
                <el-table :data="sjAllData.sjtableData.sceneList" border v-loading="sjAllData.is_loading_sj_tab" tooltip-effect="dark" style="width: 100%;font-size:12px!important;">
                  <el-table-column label="图片" min-width="100">
                    <template scope="scope">
                      <img style="width:100px;height:50px;margin-top:10px;" v-if="scope.row.imgUrl" :src="scope.row.imgUrl" />
                    </template>
                  </el-table-column>
                  <el-table-column prop="takeTime" min-width="80" label="拍摄时间">
                  </el-table-column>
                  <el-table-column min-width="100" label="操作">
                    <template scope="scope">
                      <el-button size="small" @click="handleSj(scope.$index, scope.row,1)">修改</el-button>
                      <el-button size="small" @click="handleSj(scope.$index, scope.row,2)">删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
                <el-pagination v-show="sjAllData.sjtableData.rowCount>0" style="margin: 0 auto;text-align:center;margin-top:20px" layout="prev, pager, next,jumper" :page-size=10 :currentPage="sjAllData.currentPage" @current-change="sjListCurrentChange" :total="sjAllData.sjtableData.rowCount">
                </el-pagination>
              </div>
              ...
              <div v-show="sjAllData.is_show_sj_add">
                ...
                <el-form :model="sjAllData.addNewsjType" label-width="100px" class="demo-dynamic" style="width:60%;margin-left:15%;margin-top:40px">
                  ...
                  <el-form-item label="拍摄时间" :required="true" prop="title">
                    <el-date-picker size="small" v-model="sjAllData.addNewsjType.takeTime" type="date" placeholder="拍摄时间">
                    </el-date-picker>
                  </el-form-item>

                  <el-form-item label="上传">
                    <ImgUploader2 :btnId="sjAllData.btnList[0]" @imgUploader="imgUploaderSj(0)" />
                  </el-form-item>
                  <el-form-item label="预览" class="previewFormItem">
                    <ImgPreview v-for="(item,index) in sjAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.preImgSrc" @previewImg="previewImgSj(index)" @deleteImg="deleteImgSj(index)" />
              ...
              <div v-show="sjAllData.is_show_sj_edit">
                ...
                <el-form :model="sjAllData.editNewsjType" label-width="100px" class="demo-dynamic" style="width:60%;margin-left:15%;margin-top:40px">
                  ...
                  <el-form-item label="拍摄时间" :required="true" prop="title">
                    <el-date-picker v-model="sjAllData.editNewsjType.takeTime" type="date" placeholder="拍摄时间">
                    </el-date-picker>
                  </el-form-item>

                  <el-form-item label="上传">
                    <ImgUploader2 :btnId="sjAllData._btnList[0]" @imgUploader="_imgUploaderSj(0)" />
                  </el-form-item>
                  <el-form-item label="预览" class="previewFormItem">
                    <ImgPreview v-for="(item,index) in sjAllData._preImgSrcList" :key="index" :backgroundPicUrl="item.preImgSrc" @previewImg="_previewImgSj(index)" @deleteImg="_deleteImgSj(index)" />
            ...
            <el-tab-pane label="效果图" name="third" style="padding:0px 20px">
              ...
              <el-form :model="xgAllData.addNewxgType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnId="xgAllData.btnList[0]" @imgUploader="imgUploaderXg(0)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <ImgPreview v-for="(item,index) in xgAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgXg(index)" @deleteImg="deleteImgXg(index)" />
            ...
            <el-tab-pane label="样板间" name="fourth" style="padding:0px 20px">
              ...
              <el-form :model="ybjAllData.addNewybjType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnId="ybjAllData.btnList[0]" @imgUploader="imgUploaderYbj(0)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <ImgPreview v-for="(item,index) in ybjAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgYbj(index)" @deleteImg="deleteImgYbj(index)" />
            ...
            <el-tab-pane label="规划图" name="five" style="padding:0px 20px">
              ...
              <el-form :model="ghAllData.addNewghType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnId="ghAllData.btnList[0]" @imgUploader="imgUploaderGh(0)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <ImgPreview v-for="(item,index) in ghAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgGh(index)" @deleteImg="deleteImgGh(index)" />
            ...
            <el-tab-pane label="交通图" name="six" style="padding:0px 20px">
              ...
              <el-form :model="jtAllData.addNewjtType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnId="jtAllData.btnList[0]" @imgUploader="imgUploaderJt(0)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <ImgPreview v-for="(item,index) in jtAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgJt(index)" @deleteImg="deleteImgJt(index)" />
            ...
            <el-tab-pane label="配套图" name="seven" style="padding:0px 20px">
              ...
              <el-form :model="ptAllData.addNewptType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnId="ptAllData.btnList[0]" @imgUploader="imgUploaderPt(0)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <ImgPreview v-for="(item,index) in ptAllData.preImgSrcList" :key="index" :backgroundPicUrl="item.imgUrl" @previewImg="previewImgPt(index)" @deleteImg="deleteImgPt(index)" />
            ...
            <el-tab-pane label="缩略图" name="eight" style="padding:0px 20px">
              ...
              <el-form :model="slAllData.addNewslType" label-width="100px" class="demo-dynamic">
                <el-form-item label="上传">
                  <ImgUploader2 :btnName="btnName1" style="float:left;margin-right:5px" :btnId="slAllData.btnList[0]" @imgUploader="imgUploaderSl(0)" />
                  <ImgUploader2 :btnName="btnName2" style="float:left;margin-right:5px" :btnId="slAllData.btnList[1]" @imgUploader="imgUploaderSl(1)" />
                  <ImgUploader2 :btnName="btnName3" style="float:left;margin-right:5px" :btnId="slAllData.btnList[2]" @imgUploader="imgUploaderSl(2)" />
                  <ImgUploader2 :btnName="btnName4" style="float:left;margin-right:5px" :btnId="slAllData.btnList[3]" @imgUploader="imgUploaderSl(3)" />
                  <ImgUploader2 :btnName="btnName5" style="float:left;margin-right:5px" :btnId="slAllData.btnList[4]" @imgUploader="imgUploaderSl(4)" />
                </el-form-item>
                <el-form-item label="预览" class="previewFormItem">
                  <div style="display:inline-block" v-for="(item,index) in slAllData.preImgSrcList" :key="index">
                    <ImgPreview :backgroundPicUrl="item.imgUrl" @previewImg="previewImgSl(index)" @deleteImg="deleteImgSl(index)" />
                    <p v-if="item.imgUrl" style="text-align:center;font-size:12px;margin-right:20px">缩略图{{index+1}}</p>
                  </div>
                  <p v-if="slAllData.preImgSrcList[0].imgUrl == '' &&
        ...
        <el-tab-pane label="楼盘资质" name="addeight">
            <EstateQualified />
        </el-tab-pane>
        <el-tab-pane label="楼盘总进度" name="addSeven">
          <EstateTotalProgress />
        </el-tab-pane>
      </el-tabs>
    </div>
...
import EstateTotalProgress from "../EstateTotalProgress/EstateTotalProgress"
import EstateQualified from "../EstateQualified/EstateQualified"
import EstatedirOpenP from "./EstateditOpenP.vue"
export default {
  ...
  data() {
    ...
    return {
      ...
      hxAllData: {
        ...
        addNewHouseTypeRule: {
        //   title: [{ validator: validatehxTitle, trigger: "blur" }],
          room: [{ validator: validatehxHousetype1, trigger: "blur" }],
          areaMin: [{ validator: validatehxAreaMin, trigger: "blur" }],
          roomLocation: [{ validator: validatehxOrientation, trigger: "blur" }],
          saleStatus: [{ validator: validatehxSale_state, trigger: "blur" }]
        },
        hxtableData: {
          houseList: [],
          rowCount: 0
  ...
  methods: {
    ...
    imgTabClick(tab) {
      ...
      if (name == "second") {
        ...
        if (this.xgAllData.addNewxgType.imgList.length <= 0) {
          this.getImgData(4);
        }
      } else if (name == "fourth") {
        if (this.ybjAllData.addNewybjType.imgList.length <= 0) {
          this.getImgData(3);
        }
      } else if (name == "five") {
        if (this.ghAllData.addNewghType.imgList.length <= 0) {
          this.getImgData(5);
        }
      } else if (name == "six") {
        if (this.jtAllData.addNewjtType.imgList.length <= 0) {
          this.getImgData(1);
        }
      } else if (name == "seven") {
        if (this.ptAllData.addNewptType.imgList.length <= 0) {
          this.getImgData(2);
        }
      } else if (name == "eight") {
        if (this.slAllData.bpList[0].bpId == "") {
          this.getSlData();
        }
      }
    },
    ...
    getLabelsData(type) {
      let _this = this,
        body = { lableType: type };
      this.$http(
        "/backstageBuilding/getBuildingLable",
        {},
        { body },
        {},
        "get"
    ...
    gethxdata() {
      ...
      this.$http(
        "/backstageBuilding/getBuildingHouseList",
        {},
        { body },
        {}
      ).then(function(res) {
    ...
    gethxDetaildata(scope) {
      ...
      this.$http("/backstageBuilding/getBuildingHouse", {}, { body }, {}).then(
        function(res) {
          if (res.data.code == 0) {
            ...
            if(res.data.response.propertyType != "普通住宅" 
            && res.data.response.propertyType != "公寓" 
            && res.data.response.propertyType != "商住" 
            && res.data.response.propertyType != "别墅"){
                
                _this.hxAllData.addNewHouseType.propertyType2 = res.data.response.propertyType;
                _this.hxAllData.addNewHouseType.propertyType = '0';
            }
            _this.hxAllData.preImgSrcList = [];
            for(let i = 0; i<res.data.response.houseImgUrlList.length;i++){
                _this.hxAllData.preImgSrcList[i] = res.data.response.houseImgUrlList[i];
            }
          }
        }
      );
    },
    getHouseTypeRoomLocation(){
        let _this = this;
         this.$http("/backstageBuilding/getHouseTypeRoomLocation", {}, {}, {},"post").then(
            function(res) {
            if (res.data.code == 0) {
                _this.roomLocationList = res.data.response.roomLocationList;
            }
            }
        );
    },
    ...
    initUploaderHx(index) {
      ...
      uploader2(
        function(src) {
          _this.hxAllData.preImgSrcList.push({preImgSrc : src});
        },
        function(key) {
          _this.hxAllData.addNewHouseType.houseImgUrlList.push({preImgSrc : key});
        },
        function() {
          _this.hxAllData.preImgSrcList.splice(_this.hxAllData.preImgSrcList.length-1,_this.hxAllData.preImgSrcList.length);
        },
        function(uploader) {
    ...
    //户型删除图片
    deleteImgHx(index) {
      this.hxAllData.preImgSrcList.splice(index,1);
      this.hxAllData.addNewHouseType.houseImgUrlList.splice(index,1);
      ...
      if (type == 1) {
        ...
        _this
          ...
          .then(() => {
            _this
              .$http(
                "/backstageBuilding/delBuildingHouseInfo",
                { body },
                {},
                {},
                "post"
        ...
        _this
          ...
          .then(() => {
            _this
              .$http(
                "/backstageBuilding/editHouseOnlineStatus",
                { body },
                {},
                {},
                "post"
    ...
    hx_updata_sure(formName) {
        if( this.hxAllData.addNewHouseType.houseImgUrlList.length<1){
            message(this, "请上传户型图", "success");
            return;
        }
      let _this = this,
        url = "",
        body = _.cloneDeep(_this.hxAllData.addNewHouseType);
        if(body.houseLable[0] == ""){
            body.houseLable.splice(0,1);
        }
      body.houseLable = body.houseLable.join(",");
    //   body.houseImgUrl = ""
       if(body.propertyType == 0){
            body.propertyType = body.propertyType2;
        }
            ...
            .then(() => {
              ...
              _this.$http(url, { body }, {}, {}, "post").then(res => {
                if (res.data.response.status == 1) {
                  ...
                  _this.hxAllData.addNewHouseType.houseImgUrlList = [];
                } else {
    ...
    getsjdata() {
      ...
      this.$http(
        "/backstageBuilding/getBuildingSceneList",
        {},
        { body },
        {}
      ).then(res => {
    ...
    getsjDetaildata(scope) {
      ...
      this.$http(
        "/backstageBuilding/getBuildingSceneInfo",
        {},
        { body },
        {},
        "get"
        ...
        if (res.data.code == 0) {
          ...
          _this.sjAllData._preImgSrcList[0].preImgSrc =
            _this.sjAllData.editNewsjType.imgUrl;
        }
      });
    },
    //实景-页码切换
        ...
        _this
          ...
          .then(() => {
            let _this = this,
              body = { sceneId: scope.sceneId };
            this.$http(
              "/backstageBuilding/delBuildingPicInfo",
              { body },
              {},
              {},
              "post"
    ...
    sj_updata_sure(type) {
      ...
      if (type == 1) {
        ...
        if (_this.sjAllData.editNewsjType.takeTime == "") {
          _this.$message({
            type: "warning",
            message: "请选择时间"
          });
    ...
    getSlData() {
      ...
      this.$http(
        "/backstageBuilding/getBuildingThumbnail",
        {},
        { body },
        {},
        "get"
        ...
        //   _this.slAllData.preImgSrcList = item.imgUrl;
    ...
    sl_img_submit() {
      ...
      this.$confirm("确认提交吗?", "提示", {
        ...
        .then(() => {
          ...
          _this
            .$http(
              "/backstageBuilding/editBuildingThumbnail",
              { body },
              {},
              {},
              "post"
    ...
    getImgData(type) {
      ...
      this.$http(
        "/backstageBuilding/getBuildingAlbumList",
        {},
        { body },
        {}
      ).then(res => {
        if (res.data.code == 0) {
          if (type == 1) {
            res.data.response.albumList.forEach(item => {
              _this.jtAllData.addNewjtType.imgList.push({
                imgUrl: item.imgUrl
              });
              _this.jtAllData.preImgSrcList.push({
                imgUrl: item.imgUrl
              });
            });
          } else if (type == 5) {
            res.data.response.albumList.forEach(item => {
              _this.ghAllData.addNewghType.imgList.push({
                imgUrl: item.imgUrl
              });
              _this.ghAllData.preImgSrcList.push({
                imgUrl: item.imgUrl
              });
            });
          } else if (type == 3) {
            res.data.response.albumList.forEach(item => {
              _this.ybjAllData.addNewybjType.imgList.push({
                imgUrl: item.imgUrl
              });
              _this.ybjAllData.preImgSrcList.push({
                imgUrl: item.imgUrl
              });
            });
          } else if (type == 4) {
            res.data.response.albumList.forEach(item => {
              _this.xgAllData.addNewxgType.imgList.push({
                imgUrl: item.imgUrl
              });
              _this.xgAllData.preImgSrcList.push({
                imgUrl: item.imgUrl
              });
            });
          } else if (type == 2) {
            res.data.response.albumList.forEach(item => {
              _this.ptAllData.addNewptType.imgList.push({
                imgUrl: item.imgUrl
              });
              _this.ptAllData.preImgSrcList.push({
                imgUrl: item.imgUrl
              });
            });
          }
    ...
    img_submit(type) {
      ...
      this.$confirm("确认提交吗?", "提示", {
        ...
        .then(() => {
          ...
          _this
            .$http(
              "/backstageBuilding/editBuildingPicInfo",
              { body },
              {},
              {},
              "post"
...
.estateadd .el-table th > .cell {
  text-align: center;
}
.estateadd .el-table .cell {
  text-align: center;
}
...
.previewFormItem .el-form-item__content {
  padding: 20px;
