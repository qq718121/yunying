...
export default function uploader(successfunc,successfunc2,errfunc,func,btnName,multi_selection = true){
  let _this=this;
  var uptoken='';
  var uploader='';
  axios.get('http://back.homehawkeye.com/maijiabangbackstate-1.0-SNAPSHOT/backstageUser/qiniuToken').then(function(res){
	...
	uploader = Qiniu.uploader({
	    ...
	    init: {
	      ...
	      'Key': function(up, file) {
	          ...
	          // var key = "文章"+'123';
	          var key = "pms_"+new Date().getTime()+'.jpg';
